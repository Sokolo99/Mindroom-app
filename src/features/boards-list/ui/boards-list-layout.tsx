...
import type { ViteMode } from "./vite-model-toggle";
    ...
    <div className="container mx-auto">
      <div className="flex gap-4">
        ...
        <div className="flex-1 p-4 flex flex-col gap-6">
          {template && <div className=" rounded-md bg-gray-100 p-4">{template}</div>}
          {header}
          {filters}
          {children}
        </div>
...
export function BoardsListLayoutContentGroups({ groups }: {
  groups: {
    title: string;
